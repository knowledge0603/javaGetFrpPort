...
public class EchoClientHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    private String host;
    public EchoClientHandler(String commandStr,String host) {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, ByteBuf msg) throws Exception {
        ...
        int port = Integer.parseInt(buf.toString(Charset.forName("utf-8")));
        Command.processBuilder(port,host);
    }
